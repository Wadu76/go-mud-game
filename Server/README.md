...
![AI](https://img.shields.io/badge/AI-Powered_by_Kimi-7A58F4?style=flat&logo=openai)
![Docker](https://img.shields.io/badge/Docker-Ready-2496ED?style=flat&logo=docker)
![MySQL](https://img.shields.io/badge/MySQL-8.0-4479A1?style=flat&logo=mysql)
![License](https://img.shields.io/badge/License-MIT-green)

> 一个基于 Golang 原生 TCP Socket 实现的高并发 MUD (Multi-User Dungeon) 游戏引擎。
> 摒弃了传统的 Telnet 纯文本流，采用 **Client-Server 架构**，客户端实现了基于 **TUI (终端图形界面)** 的富交互体验，并集成了 **LLM (大语言模型)** 实现智能 NPC 交互。

## 项目演示 (Screenshots)

### 核心玩法
| **战斗与死亡系统** | **背包与物品系统** | **日志系统** |
|:---:|:---:|:---:|
| <img src="/images/死亡复活系统.png" width="300" alt="Death"> | <img src="/images/背包系统.png" width="300" alt="Inventory"> | <img src="/images/日志交流.png" width="300" alt="Log"> |

###  AIGC 智能交互
> 集成 Kimi 大模型，NPC 不再是复读机，而是拥有独立人设的智能体。

| **智能 NPC 对话 (AI-Powered Dialogue)** |
|:---:|
| <img src="/images/ai对话.png" width="800" alt="AI Chat"> |
| *采用 Goroutine 异步处理 API 请求，主线程无阻塞，回复内容基于角色设定 (Persona) 动态生成* |
...
* **服务端 (Server)**:
    ...
    * **AI 集成**: 接入 **Kimi (Moonshot)** 大模型 API，使用协程实现异步非阻塞的智能对话生成。
...
2.  **AIGC 赋能 (Smart NPC)**:
    * **沉浸式交互**: 集成 LLM 大模型，NPC 拥有独立的人设 (Persona) 和性格，能根据玩家输入进行上下文相关的动态回复。
    * **异步 IO 设计**: 对话请求采用 `go func` 异步处理，确保外部 API 的网络延迟不会阻塞游戏主线程的战斗与移动逻辑。
3.  **富客户端体验 (Rich TUI)**:
...
* `login <name> <pwd>`: 登录
* `talk <NPC> <content>`: **与 NPC 进行智能对话 (例如: `talk 守卫 你好`)**
* `attack`: 攻击当前房间的怪物
...
├── ai/             # AI客户端封装 (Kimi/OpenAI API Client)
├── database/       # 数据库连接与ORM模型
